...
export const metadata: Metadata = {
  ...
  description:
    "Transform repetitive tasks into strategic growth with AI-driven automation for UK SMEs, saving time and reducing operational costs.",
  keywords: ["process automation", "workflow automation", "business efficiency", "AI automation", "task automation"],
  alternates: {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og-process-automation.jpg", // Create this image for social sharing
        width: 1200,
        height: 630,
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-violet-50 p-6 rounded-lg border border-blue-100 mb-8">
                <p className="text-lg text-gray-700 italic">
                  "UK SMEs waste countless hours on manual processes—data entry, invoicing, customer inquiries, and
                  more. Process automation powered by AI agents and workflows lets you reclaim time, slash errors, and
                  focus on innovation. Discover how to turn routine tasks into automated growth engines."
                </p>
              </div>
            </div>
          </div>
