      ...
      <section className="relative bg-gradient-brand py-20 md:py-24">
        ...
        <div className="container relative z-10 mx-auto px-4 md:px-6">
          <div className="max-w-3xl">
            <h1 className="mb-4 text-4xl font-bold tracking-tight text-white sm:text-5xl">GDPR Compliance Solutions</h1>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-violet-50 p-6 rounded-lg border border-blue-100 mb-8">
              <p className="text-lg text-gray-700">
                Navigating the complex world of GDPR compliance can be time-consuming and resource-intensive—especially
                for small and mid-sized businesses that handle large volumes of personal data. Our AI-driven GDPR
                Compliance Solutions are designed to reduce that burden by automating key compliance tasks, enhancing
                accuracy, and keeping your business audit-ready at all times.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">Automated data discovery and classification across all systems</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle2 className="h-5 w-5 text-brand-purple mr-2 flex-shrink-0 mt-0.5" />
                ...
                <li className="flex items-start">
                  <CheckCircle2 className="h-5 w-5 text-brand-purple mr-2 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Real-time monitoring and alerts for potential compliance issues</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle2 className="h-5 w-5 text-brand-purple mr-2 flex-shrink-0 mt-0.5" />
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <p className="text-center text-gray-700 mb-12 max-w-3xl mx-auto">
            ...
            solutions. That's why our GDPR platform is scalable, user-friendly, and tailored to deliver enterprise-level
          ...
          <div className="mt-12 text-center">
            <p className="text-lg text-gray-700 font-medium">
              With AI as the foundation, your business can stay compliant, secure, and competitive—no matter your size.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-12 bg-gradient-to-br from-blue-50 to-violet-50 p-6 rounded-lg">
              ...
              <p className="text-center text-gray-700">
                Our AI-powered GDPR compliance solutions help you avoid these risks while turning data protection into a
...
import { PoundSterling, AlertOctagon, AlertCircle } from "lucide-react"
