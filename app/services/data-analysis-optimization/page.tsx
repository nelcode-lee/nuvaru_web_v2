...
export const metadata: Metadata = {
  ...
  description:
    "Turn data into your competitive edge with AI-powered insights and actionable intelligence for UK SMEs to drive informed decision-making.",
  keywords: ["data analysis", "business intelligence", "data optimization", "AI analytics", "predictive analytics"],
  alternates: {
    canonical: "/services/data-analysis-optimization",
  },
  openGraph: {
    title: "Data Analysis & Optimization | Nuvaru - AI Transformation Consultancy",
    description:
      "Turn data into your competitive edge with AI-powered insights and actionable intelligence for UK SMEs.",
    url: "/services/data-analysis-optimization",
    images: [
      {
        url: "/og-data-analysis.jpg", // Create this image for social sharing
        width: 1200,
        height: 630,
...
export default function DataAnalysisOptimizationPage() {
  const serviceData = {
    title: "Data Analysis & Optimization",
    description:
      "Extract actionable insights from your business data to drive informed decision-making and optimize operations.",
  }
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-violet-50 p-6 rounded-lg border border-blue-100 mb-8">
                <p className="text-lg text-gray-700 italic">
                  ...
                  trends, and prescribing optimizations. Transform raw numbers into actionable strategies that cut
                  costs, boost revenue, and future-proof your business."
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-700 mb-6">
                  Our custom-built analytics dashboards transform complex data into clear, actionable insights. We
                  design intuitive visualizations that help you spot trends, identify opportunities, and make
