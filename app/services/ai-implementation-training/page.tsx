...
export const metadata: Metadata = {
  ...
  description:
    "Bridge the gap between AI technology and your team's success with our implementation and training services for seamless adoption.",
  keywords: ["AI implementation", "AI training", "technology adoption", "AI integration", "staff training"],
  alternates: {
    canonical: "/services/ai-implementation-training",
  },
  openGraph: {
    ...
    url: "/services/ai-implementation-training",
    images: [
      {
        url: "/og-ai-implementation.jpg", // Create this image for social sharing
        width: 1200,
        height: 630,
        alt: "AI Implementation & Training",
      },
    ],
  },
}
...
export default function AIImplementationTrainingPage() {
  const serviceData = {
    title: "AI Implementation & Training",
    description:
      "Seamless integration with existing systems and comprehensive staff training to ensure successful AI adoption.",
  }
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                ...
                <p className="text-gray-600">
                  Ongoing assistance and resources to ensure long-term adoption and success
                </p>
              </div>
            </div>
          </div>
