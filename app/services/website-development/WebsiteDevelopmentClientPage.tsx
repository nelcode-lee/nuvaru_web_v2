    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 md:py-24 bg-gradient-brand relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 opacity-30 pointer-events-none">
          <Image src="/network-pattern.webp" alt="Network pattern background" fill className="object-cover" priority={false} loading="lazy" />
        </div>
        <div className="container mx-auto px-4 md:px-6 relative z-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/contact">
                <Button className="bg-white text-blue-600 hover:bg-gray-100 hover:text-blue-700 font-semibold shadow-lg text-lg py-6 px-8 cursor-pointer relative z-30">
                  Get Your Website Audit
                </Button>
              </Link>
              <Button
                variant="outline"
                className="border-white bg-white/10 text-white hover:bg-white hover:text-blue-600 text-lg py-6 px-8 backdrop-blur-sm relative z-30"
              >
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-blue-600 to-violet-600 text-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/contact">
              <Button className="bg-white text-blue-600 hover:bg-gray-100 text-lg py-6 px-8 relative z-30">
            ...
            <Link href="/book-consultation">
              <Button
                variant="outline"
                className="border-white text-white hover:bg-white hover:text-blue-600 text-lg py-6 px-8 bg-transparent relative z-30"
              >
