...
export const metadata: Metadata = {
  ...
  keywords: ["AI readiness", "AI assessment", "AI capability", "AI maturity", "AI implementation planning"],
  alternates: {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og-ai-readiness.jpg", // Create this image for social sharing
        width: 1200,
        height: 630,
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-gray-700 mb-6">
                At Nuvaru, we understand that implementing AI solutions requires careful planning and preparation. Our
                AI Readiness Assessment provides organisations with a clear understanding of their current capabilities,
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl mb-8">
                Ready to assess your organisation's AI readiness? Contact our team to schedule an initial consultation
                and learn how our assessment can help you build a solid foundation for AI success.
              </p>
