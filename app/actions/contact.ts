...
Submitted from: Nuvaru Contact Form
    ...
    */
    ...
    console.log("Contact form submission for lee@nuvaru.co.uk:", emailContent)
    ...
    return {
      success: false,
      message:
        "Sorry, there was an error submitting your form. Please try again or email us directly at lee@nuvaru.co.uk",
    }
  }
}
...
Please contact this prospect within 24 hours to schedule their consultation.
    ...
    */
    ...
    // For now, log the submission (in production, this would be the actual email sending)
    console.log("Consultation booking for lee@nuvaru.co.uk:", emailContent)
